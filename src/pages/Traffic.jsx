...
const Traffic = () => {
  return (
    <Layout>
              <div className="h-screen overflow-x-hidden bg-ordinary px-6 py-10">
        ...
        <div className='bg-white rounded-[10px] px-6 pt-4 pb-4 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] grid grid-cols-1 lg:grid-cols-2 grid-flow-row gap-5 mx-6'>
        ...
        <div className='mt-5 px-10'>
            ...
            <div className="flex flex-col gap-5">
        <div className='mt-5 px-10'>
                <h1 className='font-semibold text-[24px] mb-2'>Leads Per Product</h1>
                <hr />
            </div>
            <div className='border-2 bg-white border-grey shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] rounded-[15px] mx-10 h-[500px] mb-5 flex flex-col items-center justify-center hover:border-yellow-400'>
              <img src="/images/notfound.png" className='h-25 w-25 mb-5'></img>
